...
SOURCES = drm-display-test.c drm-display.c
OBJECTS = $(SOURCES:.c=.o)
DEPS = $(SOURCES:.c=.d)

# Compiler

CFLAGS = -I. $(shell pkg-config --cflags cairo libdrm libudev)
LDFLAGS = -lm $(shell pkg-config --libs cairo libdrm libudev)
